...
早餐固定为：2个水煮鸡蛋 + 混合水果 + Fibre 1 Crunchy Original 125 mL（半个标准量杯，干重约31 g）+ 1%牛奶
...
- 牛奶4 L、水果2 kg、鸡蛋18个均一周吃完；鸡蛋包括早餐14个和正餐4个。Fibre 1 Crunchy Original每天125 mL（约31 g干重）、每周约217 g，搭配的牛奶已包含在4 L内。不计计划外零食、饮料和外食。
...
| 每周合计 | — | 约12,430 | 约1,020 | 约1,300 | 约380 |
| 日均 | — | 约1,780 | 约145 | 约185 | 约55 |
{.table-centered}
...
| 饮食摄入中心估计 | 约1,780 | 约12,430 |
| 热量赤字：总消耗−摄入 | 约560–600 | 约3,970–4,270 |
{.table-centered}
...
- 摄入暂用1,600–2,050 kcal/天作粗略情景范围，而不是置信区间；按同一久坐基线，对应赤字约290–780 kcal/天。实际日常活动、个体代谢差异及Coho三文鱼、豌豆胡萝卜等食材的实际重量和标签值仍可能使结果超出范围。
...
- 当前中心赤字按7,700 kcal/kg作短期粗换算，相当于约0.52–0.55 kg/周；不是保证，也不能线性推算达到目标体重的日期。体重降低后消耗会变化。[NIH体重模型说明](https://www.niddk.nih.gov/research-funding/at-niddk/labs-branches/laboratory-biological-modeling/integrative-physiology-section/research/body-weight-planner)
