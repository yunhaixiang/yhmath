...
More specifically, I am interested in Galois representations arising from geometry, arithmetic statistics, abelian varieties, Drinfeld modules, and algebraic stacks. I am also very interested in [machine learning](https://en.wikipedia.org/wiki/Machine_learning) and especially its applications to mathematics (AI for Math), including: investigating how AI could be used to discover, understand, and formalize mathematics; developing related mathematical softwares; and studying relevant questions in the foundations of mathematics.
