...
Specifically, I am interested in the study of Galois representations (and more broadly representations of the étale fundamental group) arising from geometry, and their interactions with a broad range of topics, such as abelian varieties, Drinfeld modules, arithmetic statistics, rational points, and ramification. Outside of my main interests, I am  also interested in machine learning and especially its applications to mathematical research (AI for Math).
